...
Current content status: the 2026-05-16 honest D2 audit scans `23,444` items. N5 `3,497` and N4 `3,376` have `0` machine/open-review items and are launch-tier. N3 has `0` machine items but `100` open-review grammar items. N2 has `2,752` machine and `1,004` open-review items. N1 has `4,701` machine and `1,278` open-review items. N1/N2 remain draft-tier; do not describe N5-N1 as fully human-approved.
