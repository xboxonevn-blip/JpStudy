...
10. Plural risk exists mostly for English: Q3.6 found `41` raw English count-plural strings and only `5` relevant manual singular guards. Central `AppLanguage` helper patch reduced remaining grep matches to `31`; the 2026-05-15 vocab and feature-local follow-ups reduced them to `0`.
