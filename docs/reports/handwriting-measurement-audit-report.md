...
- Generated at (UTC): `2026-04-03T01:55:55.726551Z`
- Scoring version: `v2`
- Template dataset: `422979-2026-03-18T10:57:01.000Z`
- Samples: `10`
- False positives: `4` (50.0%)
...
| `focus_private_university_extra_stroke_reject` | 私立大学 | `reject` | `accept` | `threshold` | 0.774 | `n4_l26_s067` |
| `focus_closing_extra_stroke_reject` | 閉会 | `reject` | `accept` | `threshold` | 0.765 | `n4_l29_s068` |
