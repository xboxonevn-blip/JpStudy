...
class _RecallSprintScreenState extends ConsumerState<RecallSprintScreen> {
                    ...
                    ? Column(
                        ...
                        children: [
                          ...
                          if (_selectedAnswer != null &&
                              _selectedAnswer == _correctAnswer(language)) ...[
  ...
  String _questionPrompt(AppLanguage language) => switch (language) {
    AppLanguage.en => switch (_questionIndex) {
      0 => 'Choose the best meaning for 食べる.',
      _ => 'Choose the best meaning for 飲む.',
    },
    AppLanguage.vi => switch (_questionIndex) {
      0 => 'Chọn nghĩa đúng nhất cho 食べる.',
      _ => 'Chọn nghĩa đúng nhất cho 飲む.',
    },
    AppLanguage.ja => switch (_questionIndex) {
      0 => '食べる の意味として最も近いものを選んでください。',
      _ => '飲む の意味として最も近いものを選んでください。',
    },
  };

  List<String> _questionOptions(AppLanguage language) => switch (language) {
    AppLanguage.en => switch (_questionIndex) {
  ...
  String _correctAnswer(AppLanguage language) => switch (language) {
    AppLanguage.en => switch (_questionIndex) {
      0 => 'to eat',
      _ => 'to drink',
    },
  ...
  String _correctAnswerBody(AppLanguage language) => switch (language) {
  ...
  String _wrongAnswerBody(AppLanguage language) => switch (language) {
    AppLanguage.en => switch (_questionIndex) {
      0 => '食べる means to eat.',
      _ => '飲む means to drink.',
    },
