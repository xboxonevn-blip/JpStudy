...
- `audit_handwriting_measurement.dart`: runs the deterministic handwriting measurement audit sample set (default `tooling/handwriting_audit_cases.v2.json`) and writes both `docs/reports/handwriting-measurement-audit-report.json` and `docs/reports/handwriting-measurement-audit-report.md`
...
- review `tooling/handwriting_audit_cases.v1.json` for synthetic baseline cases and `tooling/handwriting_audit_cases.v2.json` for lesson/example-derived cases
