...
CHAPTER_COUNT = 50
ENG_URL = 'https://www.tanos.co.uk/jlpt/jlpt1/vocab/n1-vocab-kanji-eng.anki'
HIRA_URL = 'https://www.tanos.co.uk/jlpt/jlpt1/vocab/n1-vocab-kanji-hiragana.anki'
TMP_DIR = Path('tmp')
OUT_DIR = Path('assets/data/content/vocab/n1')
ENG_DB = TMP_DIR / 'n1-vocab-kanji-eng.anki'
HIRA_DB = TMP_DIR / 'n1-vocab-kanji-hiragana.anki'
CACHE_PATH = TMP_DIR / 'n1_translation_cache.json'
...
def main() -> None:
    ...
    print(f'total N1 entries: {len(entries)}')
