...
void main() {
  ...
  group('FsrsService.review — subsequent recall (grades 2-4)', () {
    ...
    test(
      'easy recall (grade 4) grows stability more than normal recall (grade 3)',
      () {
    ...
    test(
      'hard recall (grade 2) grows stability less than normal recall (grade 3)',
      () {
  ...
  group('FsrsService.review — forgotten (grade 1)', () {
    ...
    test('forgotten stability is still positive (minimum 0.1)', () {
      final r = _subsequentReview(grade: 1, stability: 1.0, difficulty: 5.0);
    ...
    test('difficulty increases after forgetting', () {
      ...
      final r = _subsequentReview(grade: 1, stability: 5.0, difficulty: 5.0);
  ...
  group('FsrsService — interval minimum', () {
    test(
      'minimum interval is at least 60 seconds even for very low stability',
      () {
